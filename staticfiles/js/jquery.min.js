...
(function (a, b) {
  ...
  var c = a.document,
    ...
    f = function () {
      ...
      var _e = function e(a, b) {
          return new _e.fn.init(a, b, h);
        },
        f = a.jQuery,
        g = a.$,
        h,
      ...
      _e.fn = _e.prototype = {
        ...
        init: function init(a, d, f) {
          ...
          if (typeof a == "string") {
            ...
            if (g && (g[1] || !d)) {
              if (g[1]) {
                d = d instanceof _e ? d[0] : d, k = d ? d.ownerDocument || d : c, j = m.exec(a), j ? _e.isPlainObject(d) ? (a = [c.createElement(j[1])], _e.fn.attr.call(a, d, !0)) : a = [k.createElement(j[1])] : (j = _e.buildFragment([g[1]], [k]), a = (j.cacheable ? _e.clone(j.fragment) : j.fragment).childNodes);
                return _e.merge(this, a);
              }
          ...
          if (_e.isFunction(a)) return f.ready(a);
          a.selector !== b && (this.selector = a.selector, this.context = a.context);
          return _e.makeArray(a, this);
        },
        selector: "",
        jquery: "1.7.2",
        length: 0,
        ...
        pushStack: function pushStack(a, b, c) {
          ...
          _e.isArray(a) ? E.apply(d, a) : _e.merge(d, a), d.prevObject = this, d.context = this.context, b === "find" ? d.selector = this.selector + (this.selector ? " " : "") + c : b && (d.selector = this.selector + "." + b + "(" + c + ")");
          return d;
        },
        each: function each(a, b) {
          return _e.each(this, a, b);
        },
        ready: function ready(a) {
          _e.bindReady(), A.add(a);
          return this;
        },
        eq: function eq(a) {
          a = +a;
        ...
        map: function map(a) {
          return this.pushStack(_e.map(this, function (b, c) {
            return a.call(b, c, b);
          }));
        },
        end: function end() {
        ...
        sort: [].sort,
        splice: [].splice
      }, _e.fn.init.prototype = _e.fn, _e.extend = _e.fn.extend = function () {
        var a,
          c,
          d,
          f,
          ...
          k = arguments.length,
          l = !1;
        typeof i == "boolean" && (l = i, i = arguments[1] || {}, j = 2), _typeof(i) != "object" && !_e.isFunction(i) && (i = {}), k === j && (i = this, --j);
        for (; j < k; j++) if ((a = arguments[j]) != null) for (c in a) {
          d = i[c], f = a[c];
          if (i === f) continue;
          l && f && (_e.isPlainObject(f) || (g = _e.isArray(f))) ? (g ? (g = !1, h = d && _e.isArray(d) ? d : []) : h = d && _e.isPlainObject(d) ? d : {}, i[c] = _e.extend(l, h, f)) : f !== b && (i[c] = f);
        }
        return i;
      }, _e.extend({
        noConflict: function noConflict(b) {
          a.$ === _e && (a.$ = g), b && a.jQuery === _e && (a.jQuery = f);
          return _e;
        },
        isReady: !1,
        readyWait: 1,
        holdReady: function holdReady(a) {
          a ? _e.readyWait++ : _e.ready(!0);
        },
        ready: function ready(a) {
          if (a === !0 && ! --_e.readyWait || a !== !0 && !_e.isReady) {
            if (!c.body) return setTimeout(_e.ready, 1);
            _e.isReady = !0;
            if (a !== !0 && --_e.readyWait > 0) return;
            A.fireWith(c, [_e]), _e.fn.trigger && _e(c).trigger("ready").off("ready");
          }
        },
        bindReady: function bindReady() {
          if (!A) {
            A = _e.Callbacks("once memory");
            if (c.readyState === "complete") return setTimeout(_e.ready, 1);
            if (c.addEventListener) c.addEventListener("DOMContentLoaded", _B2, !1), a.addEventListener("load", _e.ready, !1);else if (c.attachEvent) {
              c.attachEvent("onreadystatechange", _B2), a.attachEvent("onload", _e.ready);
              var b = !1;
              try {
        ...
        isFunction: function isFunction(a) {
          return _e.type(a) === "function";
        },
        isArray: Array.isArray || function (a) {
          return _e.type(a) === "array";
        },
        ...
        isPlainObject: function isPlainObject(a) {
          if (!a || _e.type(a) !== "object" || a.nodeType || _e.isWindow(a)) return !1;
          try {
        ...
        parseXML: function parseXML(c) {
          ...
          (!d || !d.documentElement || d.getElementsByTagName("parsererror").length) && _e.error("Invalid XML: " + c);
          return d;
        },
        noop: function noop() {},
        ...
        makeArray: function makeArray(a, b) {
          ...
          if (a != null) {
            var d = _e.type(a);
            a.length == null || d === "string" || d === "function" || d === "regexp" || _e.isWindow(a) ? E.call(c, a) : _e.merge(c, a);
          }
          return c;
        },
        ...
        map: function map(a, c, d) {
          var f,
            ...
            i = 0,
            j = a.length,
            k = a instanceof _e || j !== b && typeof j == "number" && (j > 0 && a[0] && a[j - 1] || j === 0 || _e.isArray(a));
        ...
        proxy: function proxy(a, c) {
          ...
          if (!_e.isFunction(a)) return b;
          var f = F.call(arguments, 2),
            g = function g() {
              return a.apply(c, f.concat(F.call(arguments)));
            };
          g.guid = a.guid = a.guid || g.guid || _e.guid++;
          return g;
        },
        access: function access(a, c, d, f, g, h, i) {
          ...
          if (d && _typeof(d) == "object") {
            for (l in d) _e.access(a, c, l, d[l], 1, h, f);
            g = 1;
          } else if (f !== b) {
            j = i === b && _e.isFunction(f), k && (j ? (j = c, c = function c(a, b, _c) {
              return j.call(_e(a), _c);
            }) : (c.call(a, f), c = null));
        ...
        sub: function sub() {
          ...
          _e.extend(!0, a, this), a.superclass = this, a.fn = a.prototype = this(), a.fn.constructor = a, a.sub = this.sub, a.fn.init = function (d, f) {
            f && f instanceof _e && !(f instanceof a) && (f = a(f));
            return _e.fn.init.call(this, d, f, b);
          }, a.fn.init.prototype = a.fn;
          var b = a(c);
          return a;
        },
        browser: {}
      }), _e.each("Boolean Number String Function Array Date RegExp Object".split(" "), function (a, b) {
        I["[object " + b + "]"] = b.toLowerCase();
      }), z = _e.uaMatch(y), z.browser && (_e.browser[z.browser] = !0, _e.browser.version = z.version), _e.browser.webkit && (_e.browser.safari = !0), j.test(" ") && (k = /^[\s\xA0]+/, l = /[\s\xA0]+$/), h = _e(c), c.addEventListener ? _B2 = function B() {
        c.removeEventListener("DOMContentLoaded", _B2, !1), _e.ready();
      } : c.attachEvent && (_B2 = function _B() {
        c.readyState === "complete" && (c.detachEvent("onreadystatechange", _B2), _e.ready());
      });
      return _e;
    }(),
    g = {};
  f.Callbacks = function (a) {
    ...
    var c = [],
      ...
      _n = function n(b) {
        var d, e, g, h, i;
        for (d = 0, e = b.length; d < e; d++) g = b[d], h = f.type(g), h === "array" ? _n(g) : h === "function" && (!a.unique || !p.has(g)) && c.push(g);
      },
      o = function o(b, f) {
      ...
      p = {
        add: function add() {
          if (c) {
            var a = c.length;
            _n(arguments), j ? l = c.length : e && e !== !0 && (k = a, o(e[0], e[1]));
          }
          return this;
        },
