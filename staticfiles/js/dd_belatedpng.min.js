...
var DD_belatedPNG = {
  ...
  delay: 10,
  nodesFixed: 0,
  createVmlNameSpace: function createVmlNameSpace() {
    if (document.namespaces && !document.namespaces[this.ns]) {
      document.namespaces.add(this.ns, "urn:schemas-microsoft-com:vml");
    }
  },
  createVmlStyleSheet: function createVmlStyleSheet() {
    var b, a;
  ...
  readPropertyChange: function readPropertyChange() {
    var b, c, a;
    b = event.srcElement;
    if (!b.vmlInitiated) {
      return;
  ...
  vmlOpacity: function vmlOpacity(b) {
  ...
  handlePseudoHover: function handlePseudoHover(a) {
    setTimeout(function () {
  ...
  attachHandlers: function attachHandlers(i) {
    var d, c, g, e, b, f;
    d = this;
    c = {
      resize: "vmlOffsets",
  ...
  giveLayout: function giveLayout(a) {
    a.style.zoom = 1;
    if (a.currentStyle.position == "static") {
      a.style.position = "relative";
    }
  },
  copyImageBorders: function copyImageBorders(b) {
    var c, a;
    c = {
      borderStyle: true,
      borderWidth: true,
  ...
  vmlOffsets: function vmlOffsets(d) {
  ...
  figurePercentage: function figurePercentage(d, c, f, a) {
    var b, e;
    e = true;
    b = f == "X";
    switch (a) {
